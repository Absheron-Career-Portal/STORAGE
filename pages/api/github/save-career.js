export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      ...
      console.log('📡 GitHub Careers API called for STORAGE repo');
      ...
      console.log('✅ Careers saved to GitHub STORAGE successfully!');
      
      return res.status(200).json({ 
        success: true,
        message: 'Careers saved to GitHub STORAGE successfully'
      });
    } catch (error) {
